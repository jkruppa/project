...
*Die Verwendung von MS Word oder einem andere Schreibprogramme führen zu einem Abzug von 1 Punkt (mindestens 1 Punkt)*
...
*Die Präsentation ist am Ende der regulären Vorlesung im Januar möglich.* 
...
Im Folgenden ist die Tabelle für die Benotung angegeben. Es können maximal 21 Punkte erreicht werden. Um das Modul zu bestehen benötigen Sie mindestens 11 Punkte. Themen mit Teilpunkten, die in **[fett]** gedruckt sind, müssen *mindestens* erreicht werden.
...
**Die Abgabe ist digital jederzeit möglich, spätestens zum 30. Juni 2024.**
