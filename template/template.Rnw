...
Besuchen Sie die Internetseite \href{https://www.bigbookofr.com/} und w{\"a}hlen Sie
...
Im Folgenden ist die Tabelle für die Benotung angegeben. Es können maximal 27 Punkte erreicht werden. Um das Modul zu bestehen benötigen Sie mindestens 13 Punkte. Themen mit Teilpunkten, die in \textbf{fett} gedruckt sind, müssen \textbf{mindestens} erreicht werden.
...
\begin{center}
  \begin{tabular}{lll}
    ...
    \midrule
    Datenanalyse in R & 0, \textbf{1}, 2, 3, 4 & & \\[1Ex]
    R Shiny Web App & 0, 1, 2, 3, 4  & \\[1Ex]
    Pr{\"a}sentation & 0, 1  & \\[1Ex]
    Zerforschung I & 0, \textbf{1}, 2, 3, 4  & \\[1Ex]
    Zerforschung II & 0, \textbf{1}, 2  & \\[1Ex]
    Zerforschung III & 0, \textbf{1}, 2, 3, 4  & \\[1Ex]
